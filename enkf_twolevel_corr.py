...
for ntime in range(nassim):
    ...
    if use_letkf:
        ...
        if wind_obs:
            ...
            wts = letkf_calcwts_corr(hxens,xens,ominusf,oberrvar,covlocal_ob=np.vstack((covlocal_tmp,covlocal_tmp,covlocal_tmp)),corr_power=corr_power)
        else:
            wts = letkf_calcwts_corr(hxens,xens,ominusf,oberrvar,covlocal_ob=covlocal_tmp,corr_power=corr_power)
        xens = letkf_update_corr(xens,wts)
    else:
